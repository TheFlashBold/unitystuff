    ...
    public class Kit_MapVotingUI : Kit_MapVotingUIBase
    {
        ...
        public override void SetupVotes(List<MapGameModeCombo> combos)
        {
            ...
            for (int i = 0; i < combos.Count; i++)
            {
                ...
                //Setup the new entry
                newEntry.gameModeName.text = main.gameInformation.allGameModes[combos[i].gameMode].gameModeName;
                newEntry.mapName.text = main.gameInformation.allMaps[combos[i].map].mapName;
                newEntry.mapImage.sprite = main.gameInformation.allMaps[combos[i].map].mapPicture;
