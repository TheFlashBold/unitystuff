...
namespace MarsFPSKit
{
    public class Kit_SimpleChat : Kit_ChatBase
    {
        ...
        public override void DisplayChatMessage(PhotonPlayer sender, string message, int type)
        {
            //Set time
        ...
        public override void MasterClientSwitched(PhotonPlayer player)
        {
            //Set time
            lastMessageReceived = Time.time;
            //Check if we exceeded number of active entries
        ...
        public override void PlayerJoined(PhotonPlayer player)
        {
            //Set time
            lastMessageReceived = Time.time;
            //Check if we exceeded number of active entries
        ...
        public override void PlayerLeft(PhotonPlayer player)
        {
            //Set time
            lastMessageReceived = Time.time;
            //Check if we exceeded number of active entries
        ...
        void RedrawChat()
        {
            ...
            {
                if (main.myPlayer && !main.isPauseMenuOpen)
                {
