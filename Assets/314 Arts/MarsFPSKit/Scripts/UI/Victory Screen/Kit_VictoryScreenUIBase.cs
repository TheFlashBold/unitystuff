...
namespace MarsFPSKit
{
    ...
    public abstract class Kit_VictoryScreenUI : MonoBehaviour
    {
        ...
        public abstract void DisplayPlayerWinner(PhotonPlayer winner);
        ...
        public abstract void DisplayTeamWinnerWithScores(int winner, int teamOneScore, int teamTwoScore);
